  ...
  return (
    <div>
      <div className="page-header-row">
        <h1 className="page-title">Phiếu đặt phòng của tôi</h1>
        <button
          type="button"
      ...
      <p className="page-subtitle">
        Danh sách phòng bạn đã đặt và trạng thái duyệt từ quản trị viên.
      </p>
      ...
      {isEmpty && (
        <div className="empty-state">
          ...
          <p className="empty-state-title">Bạn chưa đặt phòng nào</p>
          <p>Hãy quay lại trang chủ để tìm và đặt phòng.</p>
        </div>
      )}
